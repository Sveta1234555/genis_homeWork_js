...
const shopMk = shop(prod1)(); //назва товару: banana, вартість: 135.00
const shopMk2 = shop(prod2)(); //назва товару: cherry, вартість: 75.40
const shopMk3 = shop(prod3)(); //назва товару: orange, вартість: 302.60
